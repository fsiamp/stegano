<?php
    ...
    // This is an example of how to use Stegano to hide data in images, this example is meant
    // to be run through a browser.
...
<title>Stegano example application</title>
<style type="text/css">
<!--
body {
...
<form name="steggerForm" method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
  ...
  <p>Stegano will encrypt the data before it puts it into the image, this is to insure nobody
